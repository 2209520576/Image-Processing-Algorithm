...
int main(int argc, char** argv)
{
	...
	cv::CommandLineParser parser(argc, argv, "{help h | | }{ @input | I:/Learning-and-Practice/2019Change/Image process algorithm/Img/Fig0943(a)(dark_blobs_on_light_background).tif | }");
	if (parser.has("help"))
	{
		help();
		return 0;
	...
	for (;;)
	{
		...
		if (c == 'w' || c == ' ')
		{
			...
			for (j = 0; j < markers.cols; j++)
			{
				...
				if (index == -1)
					wshed.at<Vec3b>(i, j) = Vec3b(255, 255, 255); //±ß½ç
